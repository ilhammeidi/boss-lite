    ...
    return (
      <div style={background}>
        <Typography variant="display1" gutterBottom>
          Lorem ipsum dolor <span className={Type.bold}>sit amet</span>
        </Typography>
        ...
        <Typography variant="headline" gutterBottom>
          <span className={Type.bolder}>Bolder</span>&nbsp;
          <span className={Type.bold}>Bold</span>&nbsp;
          <span className={Type.medium}>Medium</span>&nbsp;
          <br />
          <span className={Type.regular}>Regular</span>&nbsp;
          <span className={Type.light}>Light</span>&nbsp;
          <span className={Type.lighter}>Lighter</span>&nbsp;
        </Typography>
        <Typography gutterBottom>
          Duis tristique metus magna, lobortis aliquam risus euismod sit amet. Suspendisse porttitor velit nisl, feugiat tincidunt nisl mattis ut. Nulla lobortis nunc vitae nisi semper semper. <br />
        ...
        <Divider className={classes.divider} />
        <Typography variant="display1" className={classNames(Type.light, Type.uppercase)} gutterBottom>
          Vestibulum nec mi <span className={Type.bolder}>suscipit</span>
        </Typography>
        ...
        <Typography gutterBottom className={Type.uppercase}>
          Vestibulum faucibus eget erat eget pretium. Donec commodo convallis ligula, eget suscipit orci. Suspendisse potenti.<br />
        ...
        <Divider className={classes.divider} />
        <Typography variant="title" className={Type.lighter} gutterBottom>
          <span className={Type.bold}>Numbers</span> looks great! 1234<span className={classNames(Type.bold, Type.italic, Type.underline)}>56</span>7890
        </Typography>
        <Typography variant="title" className={Type.regular} gutterBottom>
          Let your Creativity Flow <span className={Type.bold}>123<sup>$</sup></span>
        </Typography>
        <Typography variant="title" className={Type.Bold} gutterBottom>
          Numerics <span className={Type.light}>123<sup className={Type.italic}>00</sup></span>
        </Typography>
        <Divider className={classes.divider} />
